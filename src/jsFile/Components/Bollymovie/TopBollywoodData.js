    ...
    return (
        <div className='bollydata'>
            <div className='bollyboxagain ' >
                ...
                <img className='bollyimageRepeat' src='./Images/B.ghajini.jpg'></img>
            ...
            <div className='bollyboxagain BOLLybox2'>
                <div className='lineofThebolly'/>
                <img className='bollyimageRepeat' src='./Images/B.villan.webp'></img>
            ...
            <div className='bollyboxagain BOLLybox3'>
                <div className='lineofThebolly'/>
                <img className='bollyimageRepeat' src='./Images/B.tzp.jpg'></img>
